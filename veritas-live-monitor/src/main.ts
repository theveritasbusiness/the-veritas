...
Sentry.init({
  ...
  release: `the-veritas-monitor@${__APP_VERSION__}`,
  environment: location.hostname === 'veritas-live-monitor.netlify.app' || location.hostname === 'theveritas.netlify.app' ? 'production'
