...
export const shareTexts = {
  twitter: (data: StoryData) =>
    ...
    `\nGenerated by The Veritas Monitor`,
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via The Veritas Monitor - geopolitical intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - The Veritas Monitor`)}`,
