          ...
          <div className="veritas-footer-inner">
            ...
            <div className="veritas-footer-brand">
              ...
              <div className="veritas-footer-socials">
                ...
                <a href="https://www.linkedin.com/company/theveritasin" target="_blank" rel="noreferrer noopener" aria-label="The Veritas on LinkedIn" className="veritas-social-icon">
                ...
                <a href="https://www.youtube.com/@thedailyveritas" target="_blank" rel="noreferrer noopener" aria-label="The Veritas on YouTube" className="veritas-social-icon">
